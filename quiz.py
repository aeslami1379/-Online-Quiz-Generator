...
import persist_json as qpersist
...
class Quiz:
    ...
    def add(self, question, correct_answer, incorrect_answers):
        """Add a quiz item to the quiz
            ...
            Raises:
                TypeError if a valid quiz item is not constructed
            """
    ...
    def match(self, question):
        """Return the matching quiz item item
    ...
    def remove(self, old_item):
        ...
        if not isinstance(old_item, QuizItem):
            raise TypeError("parameter to Quiz.remove must be QuizItem")
...
class QuizItem:
    ...
    Attributes:
         ...
         correct_answer (str): The correct answer
         incorrect_answers (list of str): List of incorrect answers
         answers: Combination of correct and incorrect_answers

    Special Methods:
        _iter_ : the iterator returns the answers in sequence, starting with the correct answer
